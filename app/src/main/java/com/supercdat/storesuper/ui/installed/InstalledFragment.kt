...
import com.supercdat.storesuper.ui.home.AdapterClass
import com.supercdat.storesuper.ui.home.DataClass
...
class InstalledFragment : Fragment() {
    ...
    private lateinit var dataList: ArrayList<DataClassInstalled>
...
//                        .show()
                ...
                dataList = ArrayList<DataClassInstalled>()
                getData()
    ...
    private fun getData() {
        for (i in appIconList.indices) {
            val dataClass = DataClassInstalled(
                appIconList[i],
        ...
        recyclerView.adapter = AdapterClassInstalled(requireActivity(), dataList)
    }
